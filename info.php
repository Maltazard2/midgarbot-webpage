...
<center>
    <table style="border: 2px ;border-spacing: 50px;border-color: black;border-style: solid;border-radius: 20px;" align="center" border = 1 align = center width = 50% height = 50% cellpadding = 10 cellspacing = 0>
